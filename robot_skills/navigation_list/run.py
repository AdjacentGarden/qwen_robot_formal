...
def main() -> int:
    ...
    parser.add_argument("--recovery-attempts", type=int, default=int(os.getenv("NAVIGATION_RECOVERY_ATTEMPTS", "1")))
...
if __name__ == "__main__":
    ...
    os.execv(sys.executable, [sys.executable, str(client), "navigation_list", *sys.argv[1:]])

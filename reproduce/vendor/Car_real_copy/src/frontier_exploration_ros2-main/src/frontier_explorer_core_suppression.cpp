...
bool FrontierExplorerCore::all_frontiers_permanently_suppressed(
  const FrontierSequence & frontiers) const
{
  return frontier_suppression_ &&
         frontier_suppression_->all_frontiers_in_session_regions(frontiers);
}

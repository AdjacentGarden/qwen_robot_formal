...
| `frontier_suppression_timeout_s`              | `double` | `90.0`  | Lifetime of unconfirmed failure-attempt records in seconds                   | Isolated failures expire without creating permanent stale state                                                |
| `frontier_suppression_region_timeout_s`       | `double` | `0.0`   | Lifetime of confirmed blocked regions in seconds                             | `0` keeps them suppressed until the current exploration session is reset                                      |
| `frontier_suppression_initial_feedback_samples_to_ignore` | `int` | `3` | Provisional Nav2 feedback samples ignored before progress tracking | The next sample establishes the initial shortest-distance baseline |
...
frontier_explorer:
  ros__parameters:
    ...
    frontier_suppression_region_timeout_s: 0.0
    frontier_suppression_initial_feedback_samples_to_ignore: 3

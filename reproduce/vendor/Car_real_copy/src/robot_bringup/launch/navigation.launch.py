...
def generate_launch_description():
    ...
    default_map_pbstream = os.path.join(bringup_share, 'map', 'default.pbstream')
    ...
    map_pbstream = LaunchConfiguration('map_pbstream')
    nav2_params_dir = LaunchConfiguration('nav2_params_dir')
    rviz_config = LaunchConfiguration('rviz_config')
    legacy_nav2_start_sim = LaunchConfiguration('legacy_nav2_start_sim')
    legacy_nav2_use_rviz = LaunchConfiguration('legacy_nav2_use_rviz')
        ...
        actions=[
            IncludeLaunchDescription(
                ...
                launch_arguments={
                    ...
                    'autostart': 'true',
                    'start_sim': legacy_nav2_start_sim,
                    'use_rviz': legacy_nav2_use_rviz,
                }.items(),
            )
        ],
    )
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('map_pbstream', default_value=default_map_pbstream),
        DeclareLaunchArgument(
            'nav2_params_dir',
            default_value=os.path.join(car_nav2_share, 'param'),
        ),
        DeclareLaunchArgument('legacy_nav2_start_sim', default_value='false'),
        DeclareLaunchArgument('legacy_nav2_use_rviz', default_value='false'),
        ...
        DeclareLaunchArgument('localization_start_delay', default_value='5.0'),

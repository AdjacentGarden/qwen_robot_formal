...
class RobotStateCollector:
    ...
    def _pose_from_named_point(self, point: str) -> dict[str, Any] | None:
        ...
        candidates = [
            ...
            Path(self.config.get("paths", {}).get("single_function_dir", "/home/test/single_function")) / "points" / "named_points.json",
            Path("/home/test/single_function/points/named_points.json"),
        ]
